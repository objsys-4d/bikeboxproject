...
For each ($oPcp; $oParticipant)
	...
	Case of 
		: (oConnection.referer="event")
			...
			End if 
			$oDataTable.push(New collection:C1472($oPcp.UUID; ""; $txtAttended; $eventDate; $personName; $txtAttended; String:C10($oPcp.amountDonated; "$###,###,##0.00"); ""))
			
		: (oConnection.referer="donation")
			$oDataTable.push(New collection:C1472($oPcp.UUID; ""; $txtAttended; $oPcp.dateEvent; $oPcp.eventName; $txtAttended; String:C10($oPcp.totalDonation; "$###,###,##0.00"); ""))
